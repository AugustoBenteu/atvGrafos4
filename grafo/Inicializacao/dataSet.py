...
def criaMatrizAdjacencias(instancia):
    ...
    caminho = 'C:/Users/bente/Desktop/Nova Pasta/Grafos/grafo/Instancias/' + instancia + '.txt'
...
def salvaResultado(resultado):
    ...
    for res in resultado:
        stringRes += str(res) + ' '
    arquivo = open('C:/Users/bente/Desktop/Nova Pasta/Grafos/grafo/Resultados/resultado.txt', 'a+')
